                ...
                {companyDetail.adminDocUrl ? (
                  <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30">
                    <div className="flex items-center gap-2">
                      ...
                      <a href={resolveFileUrl(companyDetail.adminDocUrl)} target="_blank" rel="noopener noreferrer"
              ...
              <div className="rounded-lg border border-border p-4 space-y-3">
                ...
                {ccDetail.adminDocUrl ? (
                  <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30">
                    <div className="flex items-center gap-2">
                      <FileText className="h-5 w-5 text-primary" />
                      <a href={resolveFileUrl(ccDetail.adminDocUrl)} target="_blank" rel="noopener noreferrer"
                        className="text-sm font-medium hover:text-primary transition-colors">
